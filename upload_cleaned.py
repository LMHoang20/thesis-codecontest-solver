...
def get_example(editorial):
    ...
    assert mini_prompt == '<s>' + medium_prompt, (mini_prompt, medium_prompt)
...
def main():
    ...
    print(sum(train_token_counts), sum(validate_token_counts), sum(test_token_counts))
    ...
    # plt.show()
    # plt.hist(validate_token_counts, bins = 100)
    # plt.show()
